...
def is_out_of_bounds(CURRENT_POSITION, MOVE_COORDS):
    if CURRENT_POSITION[0] + MOVE_COORDS[0] <= 0:
        return True
    elif CURRENT_POSITION[1] + MOVE_COORDS[1] <= 0:
        return True
    print(CURRENT_POSITION[0] + MOVE_COORDS[0])
    print(CURRENT_POSITION[1] + MOVE_COORDS[1])
    return False
...
def is_hitting_obstacle(CURRENT_POSITION, MOVE_COORDS, GRID_COORDS):
    ...
    if GRID_COORDS[NEW_POS[0]][NEW_POS[1]] == 1:
        print(GRID_COORDS[NEW_POS[0]][NEW_POS[1]])
        return True
    return False
...
def main():
    ...
    print("Move :", MOVE)
    print(GRID_VALUES)
    print("Is out of bounds?", is_out_of_bounds(CURRENT_POS, MOVE) )
